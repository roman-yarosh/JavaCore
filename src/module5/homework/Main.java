...
public class Main {
    ...
    public static void printSameRooms(Room[] sameRooms, API api1, API api2){
    ...
    public static void main (String[] args) {
        ...
        /* System output:
        Request to API for rooms: price = 500, persons = 1, city = 'Kyiv', hotel = 'Hilton Kyiv'
        ...
        /* System output:
        Check the same rooms for api = module5.homework.BookingComAPI and api = module5.homework.GoogleAPI with equal price, persons, cityName but not hotel name
        ...
        /* System output:
        Check the same rooms for api = module5.homework.GoogleAPI and api = module5.homework.TripAdvisorAPI with equal price, persons, cityName but not hotel name
        ...
        /* System output:
        Check the same rooms for api = module5.homework.TripAdvisorAPI and api = module5.homework.BookingComAPI with equal price, persons, cityName but not hotel name
